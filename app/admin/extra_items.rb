ActiveAdmin.register NinthAge::ExtraItem do
  ...
  permit_params :extra_item_category_id, :value_points, :max, :extra_item_activator_id, :locale, translations_attributes: [:id, :name, :description, :infos, :locale, :_destroy]
